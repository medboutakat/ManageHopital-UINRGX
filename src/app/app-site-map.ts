...
export  class  SiteMap {
  public static menu: NavItem[] = [
    ...
    { displayName: "Store", iconName: "store", route: "/store" },
    {
      ...
      children: [
        {displayName: "Appointements",iconName: "home",route: "/appointement",},
        { displayName: "Hospital", iconName: "home", route: "/hospitals" },
        { displayName: "Doctors", iconName: "home", route: "/doctors" },
        { displayName: "Customers", iconName: "home", route: "/customers" },
        ...
        { displayName: "Ourteam", iconName: "home", route: "/ourteam" },
        {displayName: "material edit",iconName: "home",route: "/materialedit",},
    ...
    },
    {
      ...
      iconName: "group",
      children: [
        {displayName: "Búsqueda Perfil",iconName: "search",route: "/busquedaperfiles",},
        { displayName: "Tax", iconName: "tax", route: "/tax" },
        {displayName: "Customer category",iconName: "category",route: "/customercat",},
        {displayName: "Hospital category",iconName: "category",route: "/hospitalcat",},
        {displayName: "DoctorCategory",iconName: "category",route: "/doctorCategory",},
        {displayName: "ProductCategory",iconName: "category",route: "/productCategory",},
      ],
    },
  ];
